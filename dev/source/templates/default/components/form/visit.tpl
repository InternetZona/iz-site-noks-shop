<form name="visit" class="form form--ajax" autocomplete="off">
    <input type="hidden" name="action" value="web/form">
    <input type="hidden" name="subject" value="Заказ замера">
    ...
    <div class="center-align">
        <button type="submit" class="form__submit form__submit--inverse" onclick="yaCounter49093180.reachGoal('zamer_send');">Отправить</button>
    </div>
</form>